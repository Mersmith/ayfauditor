            ...
            <div class="g_columna_8">
                <div class="g_panel" x-data="{ activeTab: 'general' }">
                    ...
                    <div x-show="activeTab === 'general'" x-transition class="g_tab_content">
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <input type="text" id="razon_social" wire:model.blur="razon_social"
                                class="@error('razon_social') input-error @enderror" autocomplete="off" placeholder="Ej: Aybar Consultores S.A.C.">
                            @error('razon_social')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <input type="text" id="nombre_comercial" wire:model.blur="nombre_comercial"
                                class="@error('nombre_comercial') input-error @enderror" autocomplete="off" placeholder="Ej: Aybar Corp">
                    ...
                    <div x-show="activeTab === 'contacto'" x-transition class="g_tab_content">
                        <div class="g_margin_bottom_10">
                            ...
                            <input type="text" id="direccion_fiscal" wire:model.blur="direccion_fiscal"
                                class="@error('direccion_fiscal') input-error @enderror" placeholder="Ej: Av. Las Begonias 450, San Isidro">
                        ...
                        <div class="g_fila">
                            <div class="g_margin_bottom_10 g_columna_6">
                                ...
                                <input type="email" id="correo" wire:model.blur="correo"
                                    class="@error('correo') input-error @enderror" placeholder="contacto@empresa.com">
                                @error('correo')
                                    <p class="mensaje_error">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <input type="url" id="website" wire:model.blur="website"
                                class="@error('website') input-error @enderror" placeholder="https://www.empresa.com">
                            @error('website')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="formulario_botones g_tab_form_buttons">
                        <button type="submit" class="g_boton guardar" wire:loading.attr="disabled" wire:target="store, logo, escudo">
                            <span wire:loading.remove wire:target="store">
                                <i class="fa-solid fa-save"></i> Registrar Empresa
                            </span>
