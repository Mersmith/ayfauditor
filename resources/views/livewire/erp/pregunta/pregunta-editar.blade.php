<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarPreguntaOn" message="Procesando..." />

    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Pregunta <code>#{{ $pregunta->id }}</code></h2>
        ...
        <div class="cabecera_titulo_botones">
            ...
            <button type="button" class="g_boton danger" onclick="confirmarEliminarPregunta()">
                    ...
                    <div x-show="activeTab === 'general'" x-transition class="g_tab_content">
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <textarea id="texto" wire:model.blur="texto" rows="4"
                                class="@error('texto') input-error @enderror"></textarea>
                            @error('texto')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div x-show="activeTab === 'ayuda'" x-transition class="g_tab_content">
                        <div class="g_margin_bottom_10">
                            ...
                            <textarea id="descripcion_ayuda" wire:model.blur="descripcion_ayuda" rows="8"
                                ...
                                placeholder="Escriba aquí los criterios técnicos o ejemplos..."></textarea>
    ...
    @script
    <script>
        window.confirmarEliminarPregunta = function () {
            Swal.fire({
                title: '¿Quieres eliminar esta pregunta?',
                text: "Esta acción no se puede deshacer si la pregunta ha sido usada en auditorías previas.",
                icon: 'warning',
