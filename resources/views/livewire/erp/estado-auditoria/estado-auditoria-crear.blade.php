<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Registrar Nuevo Estado de Auditoría</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.estado-auditoria.vista.lista') }}" class="g_boton light">
    ...
    <form wire:submit="store" class="formulario">
        <div class="g_fila">
                    ...
                    <div x-show="activeTab === 'general'" x-transition class="g_tab_content">
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <input type="text" id="nombre" wire:model.blur="nombre"
                                class="@error('nombre') input-error @enderror" placeholder="Ej: En Ejecución, Finalizada, etc.">
                            @error('nombre')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <textarea id="descripcion" wire:model.blur="descripcion" rows="4"
                                class="@error('descripcion') input-error @enderror" placeholder="Describa el significado de este estado..."></textarea>
                            @error('descripcion')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div x-show="activeTab === 'visual'" x-transition class="g_tab_content">
                        <div class="g_fila">
                            ...
                            <div class="g_margin_bottom_10 g_columna_6">
                                ...
                                <input type="text" id="icono" wire:model.live="icono" placeholder="fa-solid fa-circle-check">
                                <p class="g_inferior">Ej: fa-solid fa-clock, fa-solid fa-check-double</p>
                                @error('icono')
                                    <p class="mensaje_error">{{ $message }}</p>
                                @enderror
                            </div>
            ...
            <div class="g_columna_4">
                <div class="g_panel">
                    <h3>Vista Previa</h3>
                    <p class="g_inferior g_margin_bottom_15">Así se verá el estado en la plataforma.</p>
