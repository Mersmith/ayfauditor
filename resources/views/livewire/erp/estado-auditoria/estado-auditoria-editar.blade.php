<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarEstadoAuditoriaOn" message="Procesando..." />

    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Estado de Auditoría <code>#{{ $estadoAuditoria->id }}</code></h2>
    ...
    <script>
        window.confirmarEliminarEstado = function () {
            Swal.fire({
                ...
                text: "Esta acción no se puede deshacer si el estado está siendo usado en auditorías activas.",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $wire.eliminarEstadoAuditoriaOn();
                }
            });
        }
    </script>
