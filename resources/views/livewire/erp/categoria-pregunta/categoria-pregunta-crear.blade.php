<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Registrar Nueva Categoría de Pregunta</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.categoria-pregunta.vista.lista') }}" class="g_boton light">
        ...
        <div class="g_fila">
                ...
                <div class="g_panel" x-data="{ activeTab: 'general' }">
                    ...
                    <div x-show="activeTab === 'general'" x-transition class="g_tab_content">
                        ...
                        <div class="g_margin_bottom_10">
                            <label for="nombre">
                                Nombre de la Categoría <span class="obligatorio"><i class="fa-solid fa-asterisk"></i></span>
                            </label>
                            <input type="text" id="nombre" wire:model.blur="nombre"
                                class="@error('nombre') input-error @enderror" autocomplete="off" placeholder="Ej: Seguridad y Salud">
                        @error('nombre')
                            <p class="mensaje_error">{{ $message }}</p>
                        @enderror
                        </div>
                        ...
                        <div class="g_margin_bottom_10">
                            ...
                            <textarea id="descripcion" wire:model.blur="descripcion" rows="3"
                                class="@error('descripcion') input-error @enderror" placeholder="Breve descripción de la categoría..."></textarea>
                            @error('descripcion')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div x-show="activeTab === 'visual'" x-transition class="g_tab_content">
                        <div class="g_fila">
                            ...
                            <div class="g_margin_bottom_10 g_columna_6">
                                ...
                                <div style="display: flex; gap: 10px; align-items: center;">
                                    <input type="text" id="icono" wire:model.blur="icono" placeholder="fa-solid fa-list-check">
                    ...
                    <div class="formulario_botones g_tab_form_buttons">
                        <button type="submit" class="g_boton guardar" wire:loading.attr="disabled" wire:target="store">
                            <span wire:loading.remove wire:target="store">
                                <i class="fa-solid fa-save"></i> Registrar Categoría
                            </span>
            ...
            <div class="g_columna_4">
                <div class="g_panel">
                    ...
                    <p class="g_inferior g_margin_bottom_15">Así se verá en los cuestionarios.</p>
                    ...
                    <div style="padding: 20px; border: 1px dashed #ddd; border-radius: 8px; text-align: center;">
                        <div style="background-color: {{ $color }}; color: #fff; padding: 15px; border-radius: 8px; display: inline-flex; flex-direction: column; align-items: center; gap: 10px; min-width: 120px;">
                            ...
                            <span style="font-weight: bold;">{{ $nombre ?: 'Categoría' }}</span>
                        </div>
                    </div>
                </div>
            </div>
