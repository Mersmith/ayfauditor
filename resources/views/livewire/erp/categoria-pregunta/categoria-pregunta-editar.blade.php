<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarCategoriaOn" message="Procesando..." />
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            <button type="button" class="g_boton danger" onclick="confirmarEliminarCategoria()">
    ...
    @script
    <script>
        window.confirmarEliminarCategoria = function () {
            Swal.fire({
                title: '¿Quieres eliminar esta categoría?',
                text: "Esta acción no se puede deshacer si la categoría tiene preguntas asociadas.",
                icon: 'warning',
