<div>
    ...
    <form wire:submit="update">
        ...
        <div>
            ...
            <input type="text" wire:model="icono" placeholder="Ej: fa-solid fa-microchip">
        ...
        <div style="margin-top: 10px;">
            ...
            <a href="{{ route('erp.categoria-pregunta.vista.lista') }}">Cancelar</a>
        </div>
    </form>
    ...
    <div style="background-color: #fee; padding: 10px;">
        ...
        <button type="button" onclick="confirm('¿Eliminar esta categoría?') || event.stopImmediatePropagation()" wire:click="delete" style="color: red;">
            Eliminar Registro
        </button>
    </div>
</div>
