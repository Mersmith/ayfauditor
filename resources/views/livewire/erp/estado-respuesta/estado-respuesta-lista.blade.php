<div>
    ...
    <div style="margin-bottom: 10px;">
        <a href="{{ route('erp.estado-respuesta.vista.crear') }}">Crear Nuevo Estado</a>
    </div>
        ...
        <tbody>
            @foreach ($estados as $est)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('erp.estado-respuesta.vista.editar', $est->id) }}">Editar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
