<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.estado-respuesta.vista.crear') }}" class="g_boton primary">
        ...
        <div class="formulario">
            <div class="g_fila">
                <div class="g_margin_bottom_10 g_columna_6">
                    ...
                    <input type="text" wire:model.live.debounce.1300ms="buscar" placeholder="Ej: Conforme">
                </div>
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr>
                            ...
                            <td class="g_celda_centro">
                                <a href="{{ route('erp.estado-respuesta.vista.editar', $item->id) }}" class="g_accion editar"
                                    title="Editar">
