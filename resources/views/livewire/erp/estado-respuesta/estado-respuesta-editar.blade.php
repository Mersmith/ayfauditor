<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarEstadoRespuestaOn" message="Procesando..." />

    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Estado de Respuesta <code>#{{ $estadoRespuesta->id }}</code></h2>
    ...
    <script>
        window.confirmarEliminarEstado = function () {
            Swal.fire({
                ...
                text: "Esta acción no se puede deshacer si el estado está siendo usado en respuestas de auditoría.",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $wire.eliminarEstadoRespuestaOn();
                }
            });
        }
    </script>
