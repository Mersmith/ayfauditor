<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Tipos de Documentos de Empresa</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.tipo-documento-empresa.vista.crear') }}" class="g_boton primary">
        ...
        <div class="formulario">
            <div class="g_fila">
                <div class="g_margin_bottom_10 g_columna_4">
                    <label>Buscar (Nombre o Abreviatura)</label>
                    <input type="text" wire:model.live.debounce.1300ms="buscar" placeholder="Ej: RUC">
                </div>
    ...
    <div class="g_panel">
                    ...
                    @foreach ($items as $index => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="g_inferior">{{ $item->abreviatura ?? '-' }}</div>
                            </td>
                            ...
                            <td class="g_celda_centro">
                                <a href="{{ route('erp.tipo-documento-empresa.vista.editar', $item->id) }}" class="g_accion editar"
                                    title="Editar">
        ...
        @if ($items->isEmpty())
            <div class="g_vacio">
                <p>{{ $buscar ? 'No se encontraron resultados para "' . $buscar . '"' : 'No hay tipos de documentos registrados.' }}
                </p>
