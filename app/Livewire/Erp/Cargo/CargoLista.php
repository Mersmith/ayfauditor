...
class CargoLista extends Component
{
    ...
    {
        // $this->authorize('cargo.exportar-filtro');
        ...
        return Excel::download(
            ...
            'cargos_filtrados_'.now()->format('Y-m-d_H-i').'.xlsx'
        );
    }

    public function exportExcelTodo()
    {
        // $this->authorize('cargo.exportar-todo');
        ...
        return Excel::download(
            ...
            'cargos_completos_'.now()->format('Y-m-d_H-i').'.xlsx'
        );
    }
    ...
    public function render()
    {
        ...
        return view('livewire.erp.cargo.cargo-lista', compact('items'));
    }
