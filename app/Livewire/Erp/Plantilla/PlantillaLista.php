...
class PlantillaLista extends Component
{
    ...
    {
        // $this->authorize('plantilla.exportar-filtro');

        return Excel::download(
            new PlantillasExport(
                buscar: $this->buscar,
                activo: $this->activo,
            ...
            'plantillas_filtradas_'.now()->format('Y-m-d_H-i').'.xlsx'
        );
    }

    public function exportExcelTodo()
    {
        // $this->authorize('plantilla.exportar-todo');
        ...
        return Excel::download(
            ...
            'plantillas_completas_'.now()->format('Y-m-d_H-i').'.xlsx'
        );
    }
    ...
    public function render()
    {
        ...
        return view('livewire.erp.plantilla.plantilla-lista', compact('items'));
    }
